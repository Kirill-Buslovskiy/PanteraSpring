package com.javarush.lesson08.repository.impl;

import com.javarush.lesson08.model.editor.Editor;
...
public class EditorRepoImpl implements Repo<Editor> {
    ...
    private final Map<Long, Editor> memoryDatabase = new ConcurrentHashMap<>();
